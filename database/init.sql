...
COMMENT ON TABLE machine_grip_types IS 'Relación many-to-many entre máquinas y tipos de agarre';
...
COMMENT ON COLUMN machine_grip_types.machine_id IS 'ID de la máquina de ejercicio';
COMMENT ON COLUMN machine_grip_types.grip_type_id IS 'ID del tipo de agarre';

-- Mensaje de confirmación
DO $$
BEGIN
    RAISE NOTICE '🏋️ Base de datos del gimnasio inicializada correctamente';
    RAISE NOTICE '📊 Tablas creadas: users, user_routines, routine_exercises, workout_sessions, session_exercises, user_sessions, weight_records, machine_grip_types';
    ...
    RAISE NOTICE '🤝 Sistema de relación máquinas-agarres configurado';
